            ...
            <div className="flex justify-center mb-4">
              {successData.client.photoUrl ? (
                <img
                  ...
                  className="w-[250px] h-[250px] object-cover rounded-full border-4 border-green-200 shadow-lg"
                  onError={(e) => {
                    e.currentTarget.style.display = 'none'
                  }}
                />
              ) : (
                <div className="w-[250px] h-[250px] bg-gray-200 rounded-full border-4 border-green-200 shadow-lg flex items-center justify-center">
