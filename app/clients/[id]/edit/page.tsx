    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          membershipFee: client.membershipFee?.toString() || '',
  ...
  useEffect(() => {
    ...
    if (formData.joiningDate && formData.membershipType) {
      ...
      if (selectedMembership && selectedMembership.durationDays) {
        ...
        // Only update if expiry date is empty or matches the calculated one (to allow manual edits)
        setFormData(prev => {
          if (!prev.expiryDate) {
      ...
      <div className="bg-white rounded-xl shadow-lg p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            ...
            >
              {uploadingPhoto ? 'Uploading photo...' : saving ? 'Saving...' : 'Update Client'}
            </button>
            <Link
              href="/clients"
